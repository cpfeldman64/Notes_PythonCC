...
number_0 = 22
number_1 = 18
(number_0 >= 21) or (number_1 >= 18)


# Checking whether a value is in a list

cake_flavor = ['chocolate', 'vanilla', 'red velvet', 'carrot']
if 'chocolate' in cake_flavor:
    print('chocolate is on the list!')

cake_flavor.pop(3)
if 'carrot' not in cake_flavor:
    print('carrot cake is not on the list!')

cake_flavor.remove(cake_flavor[1])
if 'vanilla' not in cake_flavor:
    print('vanilla is not on the list!')
# you can still use this statement even after vanilla has been removed
# from the list entirely. It does not need to exist as a variable at all.
